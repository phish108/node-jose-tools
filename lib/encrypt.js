...
module.exports = async function (args) {
    args = require("minimist")(args, {boolean: ["F", "G", "flat", "flattened", "general", "json", "JSON", "p", "payload", "b", "beauty"]});
    ...
    process.stdout.write(format === "compact" ? token : JSON.stringify(token, null, beautyJSON) + (beautyJSON > 0 ? "\n" : ""), "UTF8");
};
