...
module.exports = async function (args) {
    args = require("minimist")(args, {boolean: ["U", "update", "q", "quiet", "K", "as-keystore" , "r", "rsa", "RSA", "e", "EC", "ec", "o", "oct", "OCT", "d", "OKP", "dh", "okp", "b", "beauty"]});
    ...
    if (!(args.q || args.quiet)) {
        if (args.K || args["as-keystore"]) {
            ...
            process.stdout.write(JSON.stringify(key.toJSON(true), null, beautyJSON), "utf8");
        }
    }
};
