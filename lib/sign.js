...
module.exports = async function (args) {
    args = require("minimist")(args, { boolean: ["N", "no-reference", "C", "compact", "F", "flat", "flattened", "G", "general", "json", "JSON", "p", "payload"]});
    ...
    return jose.JWS.createSign({ fields, format }, {key, reference})
        ...
        .final()
        .then((data) => process.stdout.write(format === "compact" ? data : JSON.stringify(data), "utf8"));
};
